        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
            ...
            <div className="sticky top-28 space-y-6 z-10">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-mosque/5">
                ...
                <div className="space-y-3">
                  <button className="w-full cursor-pointer bg-mosque hover:bg-mosque/90 text-white py-4 px-6 rounded-lg font-medium transition-all shadow-lg shadow-mosque/20 flex items-center justify-center gap-2 group">
                    <span className="material-icons text-xl group-hover:scale-110 transition-transform">
                      calendar_today
                    </span>
                    Schedule Visit
                  </button>
                  <button className="w-full cursor-pointer bg-transparent border border-nordic-dark/10 hover:border-mosque text-nordic-dark/80 hover:text-mosque py-4 px-6 rounded-lg font-medium transition-all flex items-center justify-center gap-2">
              ...
              {lat && lng && (
                <div className="h-64 w-full">
                  <DynamicPropertyMap lat={lat} lng={lng} address={location} />
                </div>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-8 lg:row-start-2 -mt-8 space-y-8 z-10 relative">
            ...
            <div className="bg-mosque/5 p-6 rounded-xl border border-mosque/10 flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <button className="whitespace-nowrap cursor-pointer px-4 py-2 bg-white border border-nordic-dark/10 rounded-lg text-sm font-semibold hover:border-mosque transition-colors text-nordic-dark">
                Calculate Mortgage
              </button>
            </div>
          </div>
      ...
      <footer className="bg-white border-t border-slate-200 mt-12 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <a
              className="text-nordic-dark/40 hover:text-mosque transition-colors"
              href="#"
            >
