          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-3 text-[#adb5b4] font-medium tracking-wider">
            ...
            <div className="space-y-3">
              ...
              <form action={signInWithGoogle}>
                <button
                  type="submit"
                  className="cursor-pointer w-full h-12 flex items-center justify-center gap-3 bg-white border border-[#f0f0f0] rounded-xl text-[#1a2d2a] font-semibold transition-all duration-200 hover:bg-gray-50 active:scale-[0.98]"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
              ...
              <form action={signInWithGitHub}>
                ...
                >
                  <svg
                    className="w-5 h-5 fill-current text-[#1a2d2a]"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    role="img"
